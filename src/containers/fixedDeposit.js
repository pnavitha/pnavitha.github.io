            ...
            <Grid container direction="row" justify="space-evenly" spacing={2}>
                ...
                <Grid item xs={12} sm={6}>
                    {state.fixedDepositRatesResult ?
                        ...
                        : <img src={require("../images/fixed_deposit_best_offer.svg")} alt="Product Management Career Mentorship Program Become a Product Manager Career Mentor for better career high salary " width="100%" />}
                </Grid>
            </Grid>
        </Paper>
