...
const AssociateJourneyInformation = () => {
       ...
       <br />
            <Paper square elevation={2} className={classes.Card}>
                <Grid container direction='column' justify="space-between" alignItems='center'>
                    ...
                    <Typography variant="body1">A Roadmap to Strengthen your Product Management Concepts</Typography>
                    <br />
       ...
       <br />
            ...
            <Paper square elevation={2} className={classes.Card}>
                <Grid container direction='column' justify="space-between" alignItems='center'>
                    ...
                    <Typography variant="body1">You Follow the Roadmap and discuss concepts with panel of PMs</Typography>
                    <br />
       ...
       <br/>
            <Paper square elevation={2} className={classes.Card}>
                <Grid container direction='column' justify="space-between" alignItems='center'>
                    ...
                    <Typography variant="body1">Become more Awesome Product Manager!</Typography>
                    <br />
...
export default AssociateJourneyInformation;